...
=> note: first solution was to use map to get all true/false values and then
count the true values, but the requirements indicate that the iteration
should stop as soon as the second true value is found, which doesn't fit with
